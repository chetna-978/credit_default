...
from credit_default.entity.config_entity import ModelPusherConfig
...
from credit_default.entity.artifact_entity import DataTransformationArtifact, ModelTrainerArtifact, ModelPusherArtifact
...
class ModelPusher:
    ...
    def initiate_model_pusher(self) -> ModelPusherArtifact:
        try:
            # Load transformer model, model, and target encoder
            logging.info(f"Loading transformer model, model, and target encoder")
